...
localStorage.setItem("sameScore", 0);
...
Game.Draw = function(context, snake) {
  ...
  this.drawStage = function() {
    ...
    if (this.collision(nx, ny) == true) {
      if(localStorage.snakeScore < snake.stage.score){
    ...
    context.fillText('HighScore: ' + localStorage.snakeScore, 5, (snake.stage.height -20));
